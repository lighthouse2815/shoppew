...
public class CustomerChatController {
    ...
    public CustomerChatController(ChatService service, AuthenticatedUser user, Clock clock) {
    ...
    ApiResponse<ConversationResponse> start(@Valid @RequestBody StartConversationRequest request) {
        return ApiResponse.success(service.start(user.id(), request), clock);
    }
    ...
    ApiResponse<PageResponse<ConversationResponse>> list(
        ...
        return ApiResponse.success(service.customerConversations(user.id(), page, size), clock);
    }
    ...
    ApiResponse<PageResponse<MessageResponse>> messages(
        ...
        return ApiResponse.success(service.customerMessages(user.id(), conversationId, page, size), clock);
    }
    ...
    ApiResponse<MessageResponse> send(
        ...
        return ApiResponse.success(service.customerSend(user.id(), conversationId, request), clock);
    }
}
